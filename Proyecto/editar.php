...
<?php
   if(isset($_GET['incidencia_id']))
    ...
    if(isset($_POST['editar'])) 
    {
      ...
      $fecha_alta = htmlspecialchars($_POST['fecha_de_alta']);
      $fecha_rev = htmlspecialchars($_POST['fecha_de_revision']);
      $fecha_sol = htmlspecialchars($_POST['fecha_de_resolucion']);
      $comentario = htmlspecialchars($_POST['comentario']);
      $query = "UPDATE Incidencias SET planta = '{$planta}' , aula = '{$aula}' , descripcion = '{$descripcion}', fecha_de_alta = '{$fecha_de_alta}', fecha_de_revision = '{$fecha_de_revision}', fecha_de_resolucion = '{$fecha_de_resolucion}', comentario = '{$comentario}' WHERE id = {$id}";
...
<h1 class="text-center">Actualizar incidencia</h1>
  <div class="container ">
    <form action="" method="post">
      ...
      <div class="form-group">
        <label for="fecha_de_alta" >Fecha alta</label>
        <input type="date" name="fecha_de_alta" class="form-control" value="<?php echo $fecha_alta  ?>">
      </div>
      <div class="form-group">
        <label for="fecha_de_revision" >Fecha revisión</label>
        <input type="date" name="fecha_de_revision" class="form-control" value="<?php echo $fecha_rev  ?>">
      </div>
      <div class="form-group">
        <label for="fecha_de_resolucion" >Fecha solución</label>
        <input type="date" name="fecha_de_resolucion" class="form-control" value="<?php echo $fecha_sol  ?>">
      </div>
      <div class="form-group">
